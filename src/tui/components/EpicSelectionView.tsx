/**
 * ABOUTME: Epic selection view component for the Loopwright TUI.
 * Displays a list of available epics for the user to select and start a Loopwright run.
 * Used when loopwright is launched without an --epic flag.
 */
