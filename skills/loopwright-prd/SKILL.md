---
name: loopwright-prd
description: "Generate a Product Requirements Document (PRD) for loopwright task orchestration. Creates PRDs with user stories that can be converted to beads issues or prd.json for automated execution. Triggers on: create a prd, write prd for, plan this feature, requirements for, spec out."
---
